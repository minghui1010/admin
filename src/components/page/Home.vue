    ...
    <el-row :gutter="20">
      <el-col :span="8">
        ...
        <el-card shadow="hover" style="height: 252px">
          ...
          Vue
          <el-progress :percentage="60" color="#42b983"></el-progress>JavaScript
          <el-progress :percentage="24" color="#f1e05a"></el-progress>CSS
          <el-progress :percentage="13"></el-progress>HTML
